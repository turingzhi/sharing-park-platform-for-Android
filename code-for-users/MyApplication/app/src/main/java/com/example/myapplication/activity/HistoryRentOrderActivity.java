...
* 查看自己租用别人车位的历史订单
* */
public class HistoryRentOrderActivity extends AppCompatActivity {
    ...
    private static final String TAG = "mysql-app-HistoryRentOrderActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_rent_order);
        iv_back = findViewById(R.id.iv_back);
        mainHandler = new Handler(getMainLooper());
        order_list = findViewById(R.id.order_list);
        re_order = findViewById(R.id.re_order);
        Log.e(TAG, "onCreate: 1" );
        context=HistoryRentOrderActivity.this;
...
//                startActivity(intent);
    ...
    private void loadOrder() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                orderList = orderDao.getAllOrderByIdRent(user_id);
    ...
    private void showOrderList() {
        if (orderAdapter == null) {        //首次加载的操作
            orderAdapter = new OrderAdapter(context, orderList, deleteClickListener);
        ...
        //租用按钮
        orderAdapter.setDeleteClickListener(new DeleteClickListener() {
                                              @Override
